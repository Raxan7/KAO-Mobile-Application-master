                    ...
                    builder: (context, snapshot) {
                      ...
                      return GestureDetector(
                        onLongPress: () => _showReactionOptions(message[
                            'message_id'], message['sender_id']), // Show reactions on long press
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  if (!isSender)
                                    CircleAvatar(
                                      ...
                                      backgroundColor: Colors
                                          .teal[200], // Avatar background color
                                      child: Text(
                                        userInitials,
                                  ...
                                  if (!isSender)
                                    const SizedBox(
                                        width:
                                            8), // Spacing between avatar and username
                                  Text(
                                    username,
                                    style: TextStyle(
                                      fontSize: 14,
                              ...
                              const SizedBox(
                                  height:
                                      4), // Spacing between username and message
                              // Message bubble
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color:
                                      isSender ? Colors.teal : Colors.grey[300],
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(
                                        height:
                                            4), // Space between message and timestamp
                                    Text(
                                      _formatTimestamp(message[
                                          'created_at']), // Format and display timestamp
                                      style: TextStyle(
                                        color: isSender
                                            ? Colors.white70
                                            : Colors.black54,
                              ...
                              if (message['reactions'] != null)
                                Padding(
                                  padding: const EdgeInsets.only(
                                      top: 4.0), // Add spacing above reaction
                ...
                Expanded(
                  child: Container(
                    constraints: const BoxConstraints(
                      maxHeight:
                          200, // Limit max height to prevent excessive growth
                    ),
                    decoration: BoxDecoration(
                      color: Colors.white,
