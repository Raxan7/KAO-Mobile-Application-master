...
import '../../widgets/cards/hotel_card.dart';
import '../../widgets/persistent_drawer.dart';
import 'bookings_page.dart';
import 'search_page.dart';
import 'hotel_list_view_page.dart';  // Import your HotelListViewPage
...
class _HotelListPageState extends State<HotelListPage> {
  ...
  void initState() {
    ...
    _realTimeUpdateService.onDataUpdated = (hotels, motels, lodges, hostels, properties) {
      fetchHotels(); // Call fetchHotels to refresh the hotel list
    };
  ...
  void _onItemTapped(int index) {
    if (index == 0) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => HotelListViewPage(
