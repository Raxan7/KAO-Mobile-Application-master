...
class MotelListViewPage extends StatefulWidget {
  final bool isDarkMode;
  final Function(bool) onThemeChanged;
  
  const MotelListViewPage({super.key, required this.isDarkMode, required this.onThemeChanged});

  @override
  State<MotelListViewPage> createState() => _MotelListViewPageState();
}

class _MotelListViewPageState extends State<MotelListViewPage> {
  String? userId;
  String? userName;
  String? userEmail;
