...
import '../../views/user/accommodation_room_list.dart';

class LodgeCard extends StatelessWidget {
  final Lodge lodge;

  const LodgeCard({super.key, required this.lodge});
